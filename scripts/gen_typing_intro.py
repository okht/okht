"""Generate typing-intro SVG from GT Eesti Text Regular Italic glyphs."""
...
FONT_PATH = Path(
    r"C:\Users\ROG\Desktop\GitHub\cht-me\public\fonts\GT-Eesti\GT-Eesti-Text-Regular-Italic-Trial.woff2"
)
OUT_PATH = Path(
    r"C:\Users\ROG\Desktop\GitHub\okht-profile\assets\profile\typing-intro-gt-eesti-text-regular-italic-v1.svg"
)
...
def main() -> None:
    ...
    parts.append(
        "  <desc>GT Eesti Text Regular Italic typing intro.</desc>\n"
    )
    parts.append("  <defs>\n    <style>\n")
    parts.append(
        """    svg { color: #000000; }
